...
import type { ChapterFormData, Chapter } from "@/lib/schemas";
...
const ChapterModal = () => {
  ...
  const chapter: Chapter | undefined = selectedSectionIndex !== null && selectedChapterIndex !== null ? sections[selectedSectionIndex].chapters[selectedChapterIndex] : undefined;
